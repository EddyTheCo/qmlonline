...
async function init() {
  ...
  rootDiv.innerHTML +=
    '<figure  id="qtspinner"> <center > <img id="logo" crossorigin="anonymous" src="img/esterlogo.png" ></img> <div id="qtstatus"></div> </center> </figure> <div class="qtscreen" id="screen" ></div>';
  ...
  if (typeof parameter.code64 !== "undefined") {
    ...
    const example =
      typeof parameter.example_url === "undefined"
        ? "simple"
        : parameter.example_url;
    const example_url =
      "https://raw.githubusercontent.com/EddyTheCo/qmlonline/main/wasm/examples/" +
      example;
